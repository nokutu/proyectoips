...
public class FacilityBooking implements DatabaseItem {
	...
	private final static String UPDATE_QUERY = "UPDATE facilitybooking SET payment_method=?, paid=?, facilitybooking_deleted=?, entrance=?, abandon=? WHERE facility_id=? AND time_start=?";
	...
	public FacilityBooking(int facilityId, int memberId, Timestamp timeStart, Timestamp timeEnd, String paymentMethod,
		...
		this(facilityId, memberId, timeStart, timeEnd, paymentMethod, paid, deletedFlag, null, null);
	}
